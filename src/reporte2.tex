...
\begin{figure}[H]
    \centering
    \includegraphics[width= 1\linewidth]{../src/graficas/Gráfica T vs P filamento.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width= 1\linewidth]{../src/graficas/Gráfica JoT^-2 vs T^-1 semilog.png}
